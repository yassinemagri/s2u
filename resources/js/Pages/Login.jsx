...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background p-4 relative overflow-hidden">
      ...
      <div className="absolute top-8 right-8 font-mono text-xs text-primary/50 z-10">SYSTEM v1.0.4</div>
      ...
      <div className="w-full max-w-md space-y-8 relative z-20">
        ...
        >
          ...
          >
            Continue Your Quest
            {glitchEffect && (
              <span className="absolute inset-0 text-[#00FFFF] ml-[3px] mt-[2px] opacity-70">Continue Your Quest</span>
            )}
          </h1>

          <p className="font-mono text-primary/70">Login to access your pixel art courses and community</p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <Link href="/forgot-password" className="font-mono text-xs text-[#FF00FF] hover:underline">
                    Forgot password?
                  </Link>
                </div>
                <div className="relative">
        ...
        <div className="text-center">
          <p className="font-mono text-sm text-primary/70">
            ...
            <Link href="/register" className="text-[#FF00FF] hover:underline">
              Register now
            </Link>
          </p>
        </div>
      ...
      <div className="absolute top-1/2 right-4 opacity-50 transform -translate-y-1/2 z-10">
        <div className="font-mono text-xs text-primary/50 writing-vertical">PRESS START TO CONTINUE</div>
      </div>
